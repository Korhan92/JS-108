...
//const filteredArray1 = newArr.filter(params => params === 6)
//const filteredArray2 = newArr.filter(item => item > 6);
//console.log(filteredArray2);
//const filteredArray3 = newArr.filter(item => (item > 6 && item < 30));
